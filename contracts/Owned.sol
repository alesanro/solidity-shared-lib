...
contract Owned {
    ...
    function transferOwnership(address newOwner) onlyContractOwner public returns (bool) {
        if (newOwner == 0x0) {
            return false;
        }
    ...
    function withdrawTokens(address[] tokens) onlyContractOwner public {
    ...
    /// This method is only allowed for contact owner.
    function withdrawEther() onlyContractOwner external {
